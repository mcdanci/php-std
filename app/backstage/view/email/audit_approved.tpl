...
<table>
    ...
    <tr>
        <td class="c3">
            Congratulations! Your registration to exhibit at the <{$project_name}> has been reviewed and approved by the Show
            Management.
        </td>
    </tr>
    <tr>
        <td class="c3">
            To officially exhibit at the <{$project_name}>, please follow the procedure below:<br/>
            Select the booth(s)of your choice <a href="<{$url.registrant_sign_in}>">here</a>. <br/>
            Make a payment for your booths(s) <a href="<{$url.registrant_order}>">here</a>.<br/>
        </td>
    </tr>
    <tr>
        <td class="c3">
            An official confirmation letter of your payment will be emailed to you after we received your payment.
        </td>
    </tr>
    <tr>
        <td class="c3">
